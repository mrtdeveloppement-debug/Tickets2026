      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between">
          ...
          {(!ticket.complaint_type) ? (
            <div className={`flex items-center gap-2 px-4 py-2 rounded-full ${getInstallColor(getInstallationStatus(ticket))}`}>
              <span className="font-semibold">{getInstallationStatus(ticket)}</span>
            </div>
          ) : (
